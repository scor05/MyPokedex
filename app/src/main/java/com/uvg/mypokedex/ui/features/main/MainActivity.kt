                ...
                Scaffold(
                    ...
                    topBar = {
                        TopBar(
                            ...
                            showFavorite = true, // Decide si mostrar el ícono de favorito
                            isFavorite = isFavoriteState, // Pasa el estado actual
                            onToggleFavorite = { isFavoriteState = !isFavoriteState } // Lógica para cambiar el estado
                        )
                    }
                ) { innerPadding ->
